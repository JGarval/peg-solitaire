...
@section('content')
    ...
    <div class="container">
        <div class="row">
            ...
            <section id="play-options" class="window flex-col-sa-c">
                <section class="container flex-col-c-c">
                    <h1>Choose options:</h1>
                    <section class="flex-col-sa-s">
                        <section class="margin-t-b">
                            <label for="default-gap">Default Gap (middle board)</label>
                            <input id="default-gap" type="radio" name="gap" value="pos-4-4" required checked>
                        </section>
                        <section class="margin-t-b">
                            <label for="random-gap">Random Gap</label>
                            <input id="random-gap" type="radio" name="gap" value="random" required>
                        </section>
                        <section class="margin-t-b">
                            <label for="timer-option">Time (in seconds):</label>
                            <input id="timer-option" type="number" name="timer-option" placeholder="0 or blank timeless" required>
                        </section>
                        <section class="flex-row-sa-c">
                            <a href="index.html">
                                <button class="btn btn-primary">Back</button>
                            </a>
                            <button class="btn btn-success" onclick="createBoard()">Play!</button>
                        </section>
                    </section>
                </section>
            </section>
    ...
    <div class="container">
        <div class="row">
            <section id="play-container" class="window flex-col-c-s">
